...
def main():
    ...
    # 1. 娓呯悊鏃ч儴缃?    print("\n=== 娓呯悊鏃ч儴缃?===")
    run(client, "docker stop yilehang-nginx yilehang-api yilehang-postgres 2>/dev/null; docker rm yilehang-nginx yilehang-api yilehang-postgres 2>/dev/null; rm -rf /opt/yilehang; echo 'cleaned'")
...
http {
    ...
    print("2. 鍦ㄦ湇鍔″櫒涓婃墽琛? cd /opt/yilehang/docker && docker-compose up -d")
