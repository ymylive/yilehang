...
.income-item:nth-child(1) { animation-delay: 0.2s; }
.income-item:nth-child(2) { animation-delay: 0.25s; }
.income-item:nth-child(3) { animation-delay: 0.3s; }
.income-item:nth-child(4) { animation-delay: 0.35s; }
