...
function goToSchedule() {
  uni.navigateTo({ url: '/pages/coach/schedule/index' })
}

function goToLessonDetail(id: number) {
  uni.navigateTo({ url: `/pages/coach/schedule/detail?id=${id}` })
}
...
function goToIncome() {
  uni.navigateTo({ url: '/pages/coach/income/index' })
}

function goToReviews() {
  uni.navigateTo({ url: '/pages/coach/reviews/index' })
}
...
.lesson-item:nth-child(1) { animation-delay: 0.25s; }
.lesson-item:nth-child(2) { animation-delay: 0.3s; }
.lesson-item:nth-child(3) { animation-delay: 0.35s; }
