<template>
  <view class="page">
    ...
    <view class="profile-card">
      ...
      <view class="info">
        <text class="name">{{ student?.name || '未绑定学员' }}</text>
...
const radarItems = [
  ...
  { key: 'agility', label: '灵敏', color: '#36A2EB' },
